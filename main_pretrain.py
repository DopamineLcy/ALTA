...
# for F1 validation
from datasets_RSNA_zeroshot import build_dataset
...
def main(args):
    ...
    # define the model
    model = alta_model.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, args=args)
    ...
    trainable_params.mark_only_ALTA_as_trainable(model)
